...
- **Highlights**: CRUD completo, testes automatizados com Pytest, deploy em AWS EC2/RDS, documentação detalhada.  

#### 2. [AutenticationCRUD](https://github.com/rayssarrsilva/autenticationcrud)
- **Stack**: Flask, SQLAlchemy, PostgreSQL, Bootstrap, Render  
- **Highlights**: Autenticação segura com Flask-Login, redefinição de senha via tokens/e-mail, deploy em Render, boas práticas de segurança (CSRF, HSTS, CSP).  

#### 3. [Pandas Cleaning Pipeline](https://github.com/rayssarrsilva/pandas-cleaning-pipeline)
- **Stack**: Python, Pandas  
